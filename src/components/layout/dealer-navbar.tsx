...
import { DEALER_NOTIFICATION_ITEMS } from "@/components/dealer/notifications/dealer-notification-items";
      ...
      <div className="mx-auto flex h-16 w-full max-w-none items-center justify-between gap-3 px-3 sm:gap-4 sm:px-4 md:px-5 lg:px-6">
        ...
        <div className="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          <div ref={messengerRef} className="relative">
            ...
            {messengerOpen ? <MessengerPanel onClose={() => setMessengerOpen(false)} userRole="dealer" /> : null}
          </div>
